        ...
        <div className={styles.container}>
            ...
            <div className={classNames('row between-sm between-md between-lg', styles.desktopContainer)}>
                <div className="col-sm-12 col-md-12 col-lg-12 hidden-mobile">
                    <Typography type="bold" variant="h1" className={`${styles.title} ${styles.robotoFont}`}>
                    ...
                    <div className="row">
                        <div className="col-sm-12 hidden-mobile">
                            <div className={styles.headerSpan}>
                                <Typography variant="span" className={`"clear-margin-padding" ${styles.robotoFont}`} letter="uppercase">
                                ...
                                <form onSubmit={formik.handleSubmit}>
                                    <div className="row center-xs start-sm">
                                        ...
                                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <Button
                                                fullWidth={false}
                                                className={styles.buttonOverrideReverse}
                                                variant="contained"
                                            ...
                                            >
                                                <Typography
                                                    variant="span"
                                                    type="regular"
                                                    className={styles.colorOverride}
                                                    letter="capitalize"
                ...
                <div className="col-xs-12 col-sm-5 col-md-5 col-lg-5 hidden-mobile">
                    <div className="row">
                        <div className="col-sm-12">
                            <div className={styles.headerSpan}>
                                <Typography className={`"clear-margin-padding" ${styles.robotoFont}`} variant="span" letter="uppercase">
                                    {t('login:newCustomer')}
                                </Typography>
                            </div>
                        </div>
